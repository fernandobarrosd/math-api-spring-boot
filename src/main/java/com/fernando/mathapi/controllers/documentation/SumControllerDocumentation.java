...
@Tag(name = "Sum operation")
public interface SumControllerDocumentation {
    @ApiResponses(value = {
            @ApiResponse(
    ...
    ResponseEntity<ResultDTO> sum(Optional<Long> numberOneOptional, Optional<Long> numberTwoOptional);
}