...
@Tag(name = "Division operation")
public interface DivisionControllerDocumentation {
    @ApiResponses(value = {
            @ApiResponse(
    ...
    ResponseEntity<?> division(Optional<Long> numberOneOptional, Optional<Long> numberTwoOptional);
